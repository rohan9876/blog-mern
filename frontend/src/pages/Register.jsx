...
const Register = () => {
  ...
  const handleRegister = async () => {
    try {
      ...
      const { username: responseUsername, email: responseEmail, password: responsePassword } = response.data;
  
      setUsername(responseUsername);
      setEmail(responseEmail);
      setPassword(responsePassword); // <-- Updated variable name
      setError(false);
